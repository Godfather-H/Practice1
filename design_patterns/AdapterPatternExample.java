...
//适配器类，将LegacyRectangle适配到Form接口上
class RectangleAdapter implements Form {
...
public class AdapterPatternExample {
    public static void main(String[] args) {
        ...
        Form formAdapter = new RectangleAdapter(legacyRectangle);
        formAdapter.draw(5, 5, 10, 10);
    }
}
