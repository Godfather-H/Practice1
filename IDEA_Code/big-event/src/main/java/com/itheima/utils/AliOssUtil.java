...
public class AliOssUtil {
    ...
    private static final String ACCESS_KEY = "LTAI5tRYFjP5MAczDvqcfjT8";
    private static final String ACCESS_SECRET = "sSp2B4NSs3gm1dIKqC5um31yxJ337A";
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKETNAME = "hyg-work1";
